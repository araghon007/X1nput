        ...
        if ((player >= 0) && (player < MAX_PLAYER_COUNT))
        {
            if (mGamePad[player])
            {
                ...
                if (SUCCEEDED(hr))
                {
					...
					state.thumbSticks.leftX = reading.LeftThumbstickX;
					state.thumbSticks.leftY = reading.LeftThumbstickY;
					state.thumbSticks.rightX = reading.RightThumbstickX;
					state.thumbSticks.rightY = reading.RightThumbstickY;
